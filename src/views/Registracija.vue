...
<div class="input-group mb-5">
  ...
  <input type="email" name="email" required class="form-control" placeholder="Ponovite Email" >
</div>
...
<div class="input-group mb-5">
  ...
  <input type="password" name="lozinka" required class="form-control" placeholder="Ponovite Lozinku" >
</div>
